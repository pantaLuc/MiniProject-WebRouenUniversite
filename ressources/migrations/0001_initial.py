# Generated by Django 3.1 on 2021-12-22 12:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('respnsables', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Ressource',
            fields=[
                ...
                ('service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ressources.service')),
            ],
        ),
        migrations.CreateModel(
